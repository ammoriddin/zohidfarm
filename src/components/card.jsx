  ...
  return (
        <div className={`hover:shadow-xl transition-all p-4 shadow max-w-sm bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700`}>
            ...
            <div className="p-5">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">Narxi: {price}</p>
                <button className="inline-flex items-center px-3 py-2 text-[20px] font-medium text-center text-white bg-[#84cc16] rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transition-colors">
                    Buyurtma qilmoq
