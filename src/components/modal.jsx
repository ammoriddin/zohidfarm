      ...
      <div className={`fixed ${obj.modalDisplay} h-[90vh] top-[50%] rounded-xl left-[50%] overflow-auto translate-x-[-50%] translate-y-[-50%] bg-white z-[100] `}>
        ...
        <div className='container'>
          <div className='text-center my-7'>
            <h1 className='text-[30px] sm:text-[40px] font-[600] text-[#1e1e1e]'>Заказать звонок</h1>
            <p className='text-[15px] sm:text-[20px] font-[400] text-[#1e1e1e]'>Введите данные для заказа обратного звонка</p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            />
            <div className="mb-6">
            <label htmlFor="tel" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Raqam</label>
            ...
            <label htmlFor="remember" className="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Я согласен на обработку моих персональных данных</label>
            </div>
