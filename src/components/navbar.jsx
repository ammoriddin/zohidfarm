        ...
        <>
            <nav className='w-full bg-[#f5f5f5]'>
                <div className='container py-5 relative'>
                    ...
                    <ul ref={navref} className={`gap-5 justify-between right-[-40rem] fixed z-[999000] bottom-0 h-[100vh] xl:right-0 transition-all xl:h-[100%] xl:relative px-6 xl:p-0 text-[18px] font-[600] bg-[#fff]  xl:bg-transparent w-[70%] flex-col md:w-[50%] xl:w-[100%] xl:flex`}>
                        ...
                        <div className='flex justify-evenly flex-col xl:flex-row'>
                            <Link onClick={() => {xmenu()}} to="popular-products" spy={true} smooth={true} offset={50} duration={500} className=' my-1 hover:text-[#000] mt-10 text-[#2f2f2fb8] transition-colors xl:my-0'><a href="">{t('navbar.popularproducts')}</a></Link>
