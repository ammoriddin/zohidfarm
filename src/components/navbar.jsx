                ...
                <div className='container py-5 relative'>
                    <div className='absolute'>
                        ...
                        <div className='flex justify-evenly flex-col xl:flex-row'>
                            <Link onClick={() => {xmenu()}} to="popular-products" spy={true} smooth={true} offset={50} duration={500} className=' my-1 hover:text-[#000] mt-16 text-[#2f2f2fb8] transition-colors xl:my-0'><a href="">{t('navbar.popularproducts')}</a></Link>
