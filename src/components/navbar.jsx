        ...
        <>
            <nav className='w-full bg-[#f5f5f5] h-[70px] '>
                <div className='container py-5 relative'>
                    ...
                    <div ref={navref} className={`gap-5 justify-between right-[-40rem] fixed z-[30] bottom-0 h-[100vh] xl:right-0 transition-all xl:h-[100%] xl:relative px-6 xl:p-0 text-[18px] font-[600] bg-[#fff]  xl:bg-transparent w-[70%] flex-col md:w-[50%] xl:w-[100%] xl:flex`}>
